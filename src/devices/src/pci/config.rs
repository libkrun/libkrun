...
impl PciConfiguration {
    pub fn new_type0(
        ...
        // Interrupt Pin stays 0: this transport only implements MSI-X, so
        // advertising INTA without _PRT makes Linux log "PCI INT A: no GSI".
        registers[15] = 0;
...
mod tests {
    ...
    #[test]
    fn type0_does_not_advertise_intx_pin() {
        ...
        assert_eq!(config.read_config_byte(0x3d), 0);
    }
}

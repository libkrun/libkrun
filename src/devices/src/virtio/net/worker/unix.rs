...
use crate::virtio::net::backend::{ConnectError, NetBackend, ReadError, WriteError};
use crate::virtio::net::device::VirtioNetBackend;
#[cfg(target_os = "linux")]
...
impl NetWorker {
    ...
    fn work(mut self) {
        ...
        loop {
            match epoll.wait(epoll_events.len(), -1, epoll_events.as_mut_slice()) {
                ...
                Err(e) => {
                    log::debug!("virtio-net: failed to consume epoll event: {e}");
                }
            }
        }
    }
    ...
    fn process_rx(&mut self) {
        match self.backend.recv() {
            ...
            #[cfg(windows)]
            Err(ReadError::NothingRead | ReadError::DescriptorStarvation | ReadError::Queue(_)) => {
            }
        }
    }

...
use super::super::{DEFAULT_VNET_HDR, FRAME_HEADER_LEN, QUEUE_SIZE, vnet_hdr_len};
...
pub struct Unixstream {
    ...
    tx_headers: Box<[[u8; FRAME_HEADER_LEN]; QUEUE_SIZE as usize]>,
...
impl Unixstream {
    ...
    pub fn new(
        ...
        Self {
            ...
            tx_consumer,
            rx_producer,
            tx_headers: Box::new([[0u8; FRAME_HEADER_LEN]; QUEUE_SIZE as usize]),

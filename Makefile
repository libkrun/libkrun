...
gen-libkrun-bindings:
	cargo build -p libkrun --features ffi
	cp target/ffier-krun.json include/ffier-krun.json
	{ echo '/* @generated by: make gen-libkrun-bindings — do not edit manually. */'; \
	  cargo run -p libkrun --features ffi --bin libkrun-gen -- c-header; } > $(LIBRARY_HEADER)
	{ printf '// @generated by: make gen-libkrun-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes,\n    clippy::new_without_default,\n    clippy::type_complexity\n)]\n'; \
	  cargo run -p libkrun --features ffi --bin libkrun-gen -- rust-client --weak; } > src/libkrun-via-cdylib-weak/src/lib.rs
	{ printf '// @generated by: make gen-libkrun-bindings — do not edit manually.\n#![allow(\n    dead_code,\n    unused_unsafe,\n    clippy::missing_safety_doc,\n    clippy::needless_lifetimes,\n    clippy::new_without_default,\n    clippy::type_complexity\n)]\n'; \
	  cargo run -p libkrun --features ffi --bin libkrun-gen -- rust-client; } > src/libkrun-via-cdylib/src/lib.rs
...
$(LIBRARY_RELEASE_$(OS)): $(INIT_BINARY_BSD)
	...
	CARGO_TARGET_DIR=$(FFI_HELPER_TARGET_DIR) cargo build --release -p libkrun --features ffi
